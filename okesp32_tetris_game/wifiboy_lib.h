// WiFiBoy Library for Arduino v2.01 
// Support Models: WiFiBoy Mini/Edu/Classic/Pro/OK:ESP32
//
// (C)2020 WiFiBoy Computing Laboratory, all rights reserved.
//
...
void lcdInit(int model); //Model 0:Mini, 1:Edu/Classic, 2:Pro, 3:OK-ESP32
...
void wb_init(int t); // mini:0 classic:1 pro:2 ok:esp:3
